...
const useCartStore = create((set) => ({
  ...initialState,
  addToCart: (newCart) =>
    set((oldState) => ({ carts: [...oldState.carts, newCart] })),
  updateQuantity: (cartId, amount) =>
    set((oldState) => ({
      carts: oldState.carts.map((el) =>
        el.cartId === cartId ? { ...el, quantity: el.quantity + amount } : el
      ),
    })),
  deleteCart: (cartId) =>
    set((oldState) => ({
      carts: oldState.carts.filter((el) => el.cartId !== cartId),
    })),
}));
